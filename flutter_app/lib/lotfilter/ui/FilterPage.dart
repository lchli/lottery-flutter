          ...
          return Scaffold(
              ...
              body: SingleChildScrollView(
                  child: ConstrainedBox(
                      constraints:
                          BoxConstraints(minHeight: 100, maxHeight: 1000),
                      child: new Column(
                        children: <Widget>[
                          new Row(children: <Widget>[
                            ...
                            _paddingRight(),
                            _addContainer(
                                Text(state?.danmasChecked?.toString()),
                                () async {
                              List<String> checkedList =
                                  await Navigator.of(context).push(
                                      ChooseDanMaPage.route(
                          ...
                          new Row(children: <Widget>[
                            ...
                            _paddingRight(),
                            _addContainer(
                                Text(state.dingErMaChecked.toString()),
                                () async {
                              List<String> checkedList =
                                  await Navigator.of(context).push(
                                      ChooseDanMaPage.route(
                          ...
                          RaisedButton(
                            ...
                            child: new Text('导入历史记录'),
                          ),
                          Expanded(flex:1,child:
                          TextField(
                            controller: state.controllerHis,
                            maxLines: 100,
                            readOnly: false,
                          )),
                  Expanded(flex:1,child:
